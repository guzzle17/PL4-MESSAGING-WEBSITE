...
const Form = () => {
    const [isSignInPage, setIsSignInPage] = useState(true); // Thêm state để quản lý chế độ
    ...
    return (
        <div className='bg-white w-[600px] h-[800px] shadow-lg rounded-lg flex flex-col justify-center items-center gap-2'>
